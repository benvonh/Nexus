...
void rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rviz_resource_interfaces__srv__GetResource_Event__init(message_memory);
}

void rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_fini_function(void * message_memory)
{
  rviz_resource_interfaces__srv__GetResource_Event__fini(message_memory);
}

size_t rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__size_function__GetResource_Event__request(
  const void * untyped_member)
{
  const rviz_resource_interfaces__srv__GetResource_Request__Sequence * member =
    (const rviz_resource_interfaces__srv__GetResource_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_const_function__GetResource_Event__request(
  const void * untyped_member, size_t index)
{
  const rviz_resource_interfaces__srv__GetResource_Request__Sequence * member =
    (const rviz_resource_interfaces__srv__GetResource_Request__Sequence *)(untyped_member);
...
void * rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_function__GetResource_Event__request(
  void * untyped_member, size_t index)
{
  rviz_resource_interfaces__srv__GetResource_Request__Sequence * member =
    (rviz_resource_interfaces__srv__GetResource_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__fetch_function__GetResource_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rviz_resource_interfaces__srv__GetResource_Request * item =
    ((const rviz_resource_interfaces__srv__GetResource_Request *)
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_const_function__GetResource_Event__request(untyped_member, index));
  rviz_resource_interfaces__srv__GetResource_Request * value =
    (rviz_resource_interfaces__srv__GetResource_Request *)(untyped_value);
  *value = *item;
}

void rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__assign_function__GetResource_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rviz_resource_interfaces__srv__GetResource_Request * item =
    ((rviz_resource_interfaces__srv__GetResource_Request *)
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_function__GetResource_Event__request(untyped_member, index));
  const rviz_resource_interfaces__srv__GetResource_Request * value =
    (const rviz_resource_interfaces__srv__GetResource_Request *)(untyped_value);
  *item = *value;
}

bool rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__resize_function__GetResource_Event__request(
  void * untyped_member, size_t size)
{
  rviz_resource_interfaces__srv__GetResource_Request__Sequence * member =
    (rviz_resource_interfaces__srv__GetResource_Request__Sequence *)(untyped_member);
  rviz_resource_interfaces__srv__GetResource_Request__Sequence__fini(member);
  return rviz_resource_interfaces__srv__GetResource_Request__Sequence__init(member, size);
}

size_t rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__size_function__GetResource_Event__response(
  const void * untyped_member)
{
  const rviz_resource_interfaces__srv__GetResource_Response__Sequence * member =
    (const rviz_resource_interfaces__srv__GetResource_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_const_function__GetResource_Event__response(
  const void * untyped_member, size_t index)
{
  const rviz_resource_interfaces__srv__GetResource_Response__Sequence * member =
    (const rviz_resource_interfaces__srv__GetResource_Response__Sequence *)(untyped_member);
...
void * rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_function__GetResource_Event__response(
  void * untyped_member, size_t index)
{
  rviz_resource_interfaces__srv__GetResource_Response__Sequence * member =
    (rviz_resource_interfaces__srv__GetResource_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__fetch_function__GetResource_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rviz_resource_interfaces__srv__GetResource_Response * item =
    ((const rviz_resource_interfaces__srv__GetResource_Response *)
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_const_function__GetResource_Event__response(untyped_member, index));
  rviz_resource_interfaces__srv__GetResource_Response * value =
    (rviz_resource_interfaces__srv__GetResource_Response *)(untyped_value);
  *value = *item;
}

void rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__assign_function__GetResource_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rviz_resource_interfaces__srv__GetResource_Response * item =
    ((rviz_resource_interfaces__srv__GetResource_Response *)
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_function__GetResource_Event__response(untyped_member, index));
  const rviz_resource_interfaces__srv__GetResource_Response * value =
    (const rviz_resource_interfaces__srv__GetResource_Response *)(untyped_value);
  *item = *value;
}

bool rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__resize_function__GetResource_Event__response(
  void * untyped_member, size_t size)
{
  rviz_resource_interfaces__srv__GetResource_Response__Sequence * member =
    (rviz_resource_interfaces__srv__GetResource_Response__Sequence *)(untyped_member);
  rviz_resource_interfaces__srv__GetResource_Response__Sequence__fini(member);
  return rviz_resource_interfaces__srv__GetResource_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rviz_resource_interfaces__srv__GetResource_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rviz_resource_interfaces__srv__GetResource_Event, request),  // bytes offset in struct
    NULL,  // default value
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__size_function__GetResource_Event__request,  // size() function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_const_function__GetResource_Event__request,  // get_const(index) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_function__GetResource_Event__request,  // get(index) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__fetch_function__GetResource_Event__request,  // fetch(index, &value) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__assign_function__GetResource_Event__request,  // assign(index, value) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__resize_function__GetResource_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rviz_resource_interfaces__srv__GetResource_Event, response),  // bytes offset in struct
    NULL,  // default value
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__size_function__GetResource_Event__response,  // size() function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_const_function__GetResource_Event__response,  // get_const(index) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__get_function__GetResource_Event__response,  // get(index) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__fetch_function__GetResource_Event__response,  // fetch(index, &value) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__assign_function__GetResource_Event__response,  // assign(index, value) function pointer
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__resize_function__GetResource_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_members = {
  "rviz_resource_interfaces__srv",  // message namespace
  "GetResource_Event",  // message name
  3,  // number of fields
  sizeof(rviz_resource_interfaces__srv__GetResource_Event),
  false,  // has_any_key_member_
  rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_member_array,  // message members
  rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_type_support_handle = {
  0,
  &rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rviz_resource_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource_Event)() {
  rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource_Request)();
  rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource_Response)();
  if (!rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_type_support_handle.typesupport_identifier) {
    rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t rviz_resource_interfaces__srv__detail__get_resource__rosidl_typesupport_introspection_c__GetResource_service_type_support_handle = {
  ...
  &rviz_resource_interfaces__srv__GetResource_Request__rosidl_typesupport_introspection_c__GetResource_Request_message_type_support_handle,
  &rviz_resource_interfaces__srv__GetResource_Response__rosidl_typesupport_introspection_c__GetResource_Response_message_type_support_handle,
  &rviz_resource_interfaces__srv__GetResource_Event__rosidl_typesupport_introspection_c__GetResource_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rviz_resource_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_resource_interfaces, srv, GetResource_Event)()->data;
  }

...
{
public:
  explicit Init_GetResource_Event_response(::rviz_resource_interfaces::srv::GetResource_Event & msg)
  : msg_(msg)
  {}
  ::rviz_resource_interfaces::srv::GetResource_Event response(::rviz_resource_interfaces::srv::GetResource_Event::_response_type arg)
  {
...
private:
  ::rviz_resource_interfaces::srv::GetResource_Event msg_;
};

class Init_GetResource_Event_request
{
public:
  explicit Init_GetResource_Event_request(::rviz_resource_interfaces::srv::GetResource_Event & msg)
  : msg_(msg)
  {}
  Init_GetResource_Event_response request(::rviz_resource_interfaces::srv::GetResource_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetResource_Event_request info(::rviz_resource_interfaces::srv::GetResource_Event::_info_type arg)
  {
...
template<>
inline
auto build<::rviz_resource_interfaces::srv::GetResource_Event>()
{
  return rviz_resource_interfaces::srv::builder::Init_GetResource_Event_info();
}

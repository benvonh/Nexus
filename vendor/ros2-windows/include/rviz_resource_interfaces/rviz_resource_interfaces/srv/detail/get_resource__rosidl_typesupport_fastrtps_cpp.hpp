...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rviz_resource_interfaces
cdr_serialize(
  const rviz_resource_interfaces::srv::GetResource_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rviz_resource_interfaces::srv::GetResource_Event & ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rviz_resource_interfaces
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rviz_resource_interfaces, srv, GetResource_Event)();

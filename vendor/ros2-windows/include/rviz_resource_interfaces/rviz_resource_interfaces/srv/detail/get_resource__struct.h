...
enum
{
  rviz_resource_interfaces__srv__GetResource_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rviz_resource_interfaces__srv__GetResource_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetResource in the package rviz_resource_interfaces.
typedef struct rviz_resource_interfaces__srv__GetResource_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rviz_resource_interfaces__srv__GetResource_Request__Sequence request;
  rviz_resource_interfaces__srv__GetResource_Response__Sequence response;
} rviz_resource_interfaces__srv__GetResource_Event;

// Struct for a sequence of rviz_resource_interfaces__srv__GetResource_Event.
typedef struct rviz_resource_interfaces__srv__GetResource_Event__Sequence
{

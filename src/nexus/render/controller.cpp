...
template void Nexus::Controller::move<Nexus::Controller::Direction::FORWARD>(const float);
template void Nexus::Controller::move<Nexus::Controller::Direction::BACKWARD>(const float);
template void Nexus::Controller::move<Nexus::Controller::Direction::LEFT>(const float);
template void Nexus::Controller::move<Nexus::Controller::Direction::RIGHT>(const float);
template void Nexus::Controller::move<Nexus::Controller::Direction::UP>(const float);
template void Nexus::Controller::move<Nexus::Controller::Direction::DOWN>(const float);

template <Nexus::Controller::Direction D>
void Nexus::Controller::move(const float dt)
{
...
void Nexus::Controller::look(const float dx, const float dy, const float dt)
{
...
void Nexus::Controller::transform_from(const pxr::GfCamera &camera)
{
